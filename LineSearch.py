# -*- coding: utf-8 -*-
# @Time : 2021/12/27 13:31
# @Author : ChrisPeng
# @FileName: LineSearch.py
# @Software: PyCharm
...
if __name__ == "__main__":
    ...
    print("fibonacci搜索: expect 2.98; real:", fr)

    # x* = 1.609
    def_field3 = [1, 2.0]
    gr = golden_section_search(f3, def_field3, 0.01)
    print("黄金分割搜索: expect 1.609; real:", gr)
    ...
    print("非精确搜索多项式拟合法, expect x: 0.63, 0.52; real:", rst)


    # x* = 0.609
    # rst: 0.531
    rst = quadratic_polynomial(f3, 1, 1)
    print("非精确搜索多项式拟合法, expect x: 0.609, 0.531; real:", rst)
